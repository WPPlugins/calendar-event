=== Calendar - Event Calendar, Flexible Calendar & Events ===
Contributors: totalsoft
Donate link: http://total-soft.pe.hu/calendar-event
Tags: Calendar, date, Event, event calendar, events, responsive calendar, responsive event
...
Event Calendar plugin created for showing your events. Total Soft Calendar is the best if you want to be original on your website.
...
* [Event Calendar Support](https://wordpress.org/support/plugin/calendar-event)


> Responsive Event Calendar Live Demos.
> 
...
The Responsive Events Calendar Pro Features
...
Date Background Color - Note the background color of the current day.
Date Color - Choose the current date color, that will be displayed.
Date Size - Set the size of the numbers by pixels.

### Event Days Options.

Days Background Color - Select the background for event days.
Event Days Color - Select the color of the numbers.
Event Days Size - Note the size of the numbers, it is fully responsive.
